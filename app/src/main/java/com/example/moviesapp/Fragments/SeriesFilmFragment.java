...
import com.example.moviesapp.databinding.FragmentSeriesFilmBinding;
 ...
 * Use the {@link SeriesFilmFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class SeriesFilmFragment extends Fragment {
    private FragmentSeriesFilmBinding binding;
     ...
     * @return A new instance of fragment SeriesFilmFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static SeriesFilmFragment newInstance(String param1, String param2) {
        SeriesFilmFragment fragment = new SeriesFilmFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentSeriesFilmBinding.inflate(inflater, container, false);
        View rootView = binding.getRoot();
        recycler = binding.recyclerSeries;
        more = binding.textViewSeries;
        more.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getActivity(), ListMoviesActivity.class);
                intent.putExtra("keywordSeries","moreSeries");
        ...
        homeViewModel.getSeries().observe(getViewLifecycleOwner(), new Observer<List<Item>>() {
            ...
            public void onChanged(List<Item> items) {
                ...
                binding.progressSeries.setVisibility(View.GONE);
